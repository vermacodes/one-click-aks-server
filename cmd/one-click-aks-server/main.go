...
func main() {
	...
	terraformService := service.NewTerraformService(terraformRepository, labService, workspaceService, logStreamService, actionStatusService, kVersionService, aroVersionService, storageAccountService, authService, prefService, *appConfig)
