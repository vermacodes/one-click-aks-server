...
// CustomHandler wraps JSONHandler to format source as "file:line"
...
//
// LOG_LEVEL environment variable supports both formats:
...
func SetupLogger() {
	...
	default:
		...
		if err != nil {
			slog.Error("Invalid LOG_LEVEL value", "value", logLevel, "error", err.Error())
